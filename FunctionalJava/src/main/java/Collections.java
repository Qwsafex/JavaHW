...
public class Collections {
    public static <Return, Param> List<Return> map(Function1<? extends Return, ? super Param> f, Iterable<Param> iterable){
    ...
    public static <Return> Return foldl(Function2<? extends Return, ? super Return, ? super Return> f, Return ini, Iterable<Return> iterable){
        Return result = ini;
    ...
    public static <Return> Return foldr(Function2<? extends Return, ? super Return, ? super Return> f, Return ini, Iterable<Return> iterable){
        return foldr(f, ini, iterable.iterator());
    }
    private static <Return> Return foldr(Function2<? extends Return, ? super Return, ? super Return> f, Return ini, Iterator<Return> iterator) {
        if(!iterator.hasNext()){
            return ini;
        }
